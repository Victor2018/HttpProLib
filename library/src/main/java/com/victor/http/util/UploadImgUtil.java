...
public class UploadImgUtil {
    ...
    public static String uploadFile(File file, String RequestURL) {
        ...
        try {
            ...
            if(file!=null) {
                ...
                String result = changeInputStream(conn.getInputStream());
    ...
    public static void main (String[] args) {
        String url = "http://120.77.218.62:39003/api/tblcontactsdiy_rest/allof/";
        uploadFile(new File("d:/bug/p_03.png"),url);
//        String url = "http://127.0.0.1:8080/UploadFileServer/upload?action=uploadImg";
//        uploadFile(new File("d:/bug/p_03.png"),url);
    }
